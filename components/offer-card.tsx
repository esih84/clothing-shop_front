...
export function OfferCard({ id, title, price, originalPrice, discount, imageUrl }: OfferCardProps) {
      ...
      <div className="p-2">
        <div className="flex justify-between items-start">
          ...
          <button onClick={handleToggleWishlist} className="p-1">
            <Heart
              className={`w-4 h-4 sm:w-5 sm:h-5 ${isInWishlist ? "fill-red-500 text-red-500" : "text-gray-400"}`}
            />
          </button>
        </div>
