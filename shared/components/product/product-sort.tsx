...
export function ProductSort() {
  ...
  return (
    <select
      ...
      dir="rtl"
      className="rounded-2xl border border-border bg-card px-3 py-2 text-sm text-foreground focus:outline-none focus:border-secondary/60 focus:ring-2 focus:ring-secondary/15 transition-all"
