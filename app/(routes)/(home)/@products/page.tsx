        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="animate-pulse">
              ...
              <div className="bg-gray-200 h-4 rounded-full w-3/4 mb-2"></div>
              <div className="bg-gray-200 h-3 rounded-full w-1/2 mb-2"></div>
              <div className="bg-gray-200 h-4 rounded-full w-1/4"></div>
            </div>
          ))}
        </div>
      </div>
