...
import { Search, Plus, Calendar, MessageSquare, Edit, Trash2 } from "lucide-react"
...
export default function BlogPage() {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt: "Learn the art of creating stylish minimalist outfits with fewer pieces.",
      date: "Apr 20, 2025",
      comments: 8,
      imageUrl: "/placeholder.svg?height=120&width=120",
    },
    {
      ...
      excerpt: "Everything you need to know about sustainable and ethical fashion choices.",
      date: "Apr 15, 2025",
      comments: 15,
      imageUrl: "/placeholder.svg?height=120&width=120",
    },
  ...
  return (
    <div className="p-4 space-y-4">
      <div className="flex justify-between items-center">
        ...
        <button className="bg-main p-2 rounded-full" onClick={() => router.push(`/shop/${shopId}/blog/create`)}>
            ...
            <div className="flex">
              ...
              <div>
                <Link href={`/shop/${shopId}/blog/${post.id}`}>
                  <h3 className=" font-normal text-sm md:text-md md:font-bold">{post.title}</h3>
                </Link>
                <p className="text-xs md:text-sm text-gray-500  line-clamp-1 md:line-clamp-2 mt-1">{post.excerpt}</p>
                </div>
                <div className="flex justify-between items-center ">
                  ...
                  <div className="flex space-x-1 md:space-x-2">
                    ...
                    <button className="text-red-500" onClick={() => handleDeleteClick(post.id, post.title)}>
